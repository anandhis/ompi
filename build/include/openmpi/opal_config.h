...
#define OPAL_PACKAGE_STRING "Open MPI anandhi@localhost.localdomain Distribution"
...
#define OPAL_REPO_REV "dev-3510-g1c9984f"
...
#define ORTE_REPO_REV "dev-3510-g1c9984f"
...
#define WRAPPER_EXTRA_LIBS "-lm -lnuma -ludev -ldl -lutil "
